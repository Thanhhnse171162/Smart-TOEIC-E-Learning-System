...
import { BookOpen, CheckCircle2, EyeOff, Loader2 } from "lucide-react";
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-background">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-foreground mb-8">Log in to your account</h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="password" type="password" placeholder="••••••••" className="rounded-xl pr-10" />
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="border-gray-300 data-[state=checked]:bg-[#4b6cb7] data-[state=checked]:border-[#4b6cb7]" />
            ...
            <Link href="/student/dashboard" className="block pt-4">
              <Button className="w-full rounded-xl bg-[#4b6cb7] hover:bg-[#3b5b9c] text-white" size="lg">Log in</Button>
            </Link>
            ...
            <p className="text-center text-sm text-muted-foreground pt-2">
              ...
              <Link href="/register" className="text-[#4b6cb7] font-semibold hover:underline">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
